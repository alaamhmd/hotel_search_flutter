...
**GitHub**: [Buenro/hotel-search](https://github.com/Buenro/hotel-search)
...
Created and launched a Pixel 6 emulator with API 31&34:

flutter emulators --launch Pixel 6
...
2. Key CI Configuration Details
   Steps Overview:
...
The android-emulator-runner action sets up and runs the Android emulators with the specified API levels. It waits for the emulator to fully boot before running the Flutter integration tests.
The integration tests are run using flutter test with the results saved in a test-results.json file.
...
3. CI Reporting and Test Artifacts
   Test Reports:
